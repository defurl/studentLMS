...
| 2026-04-19 | Auto-assign student role and restrict lecturer to owner Gmail | [src/App.tsx](../src/App.tsx), [firestore.rules](../firestore.rules), [FIREBASE_SETUP.md](../FIREBASE_SETUP.md), [.github/logs.md](logs.md), [.github/lessons.md](lessons.md) | Ran `npm run lint` and `npm run build` successfully | New sign-ins are auto-provisioned by email policy, and Firestore now blocks unauthorized teacher role/profile and assignment write escalation |
| 2026-04-19 | Harden gitignore for credential and log safety | [.gitignore](../.gitignore), [.github/logs.md](logs.md), [.github/lessons.md](lessons.md) | Verified patterns with `git check-ignore` and audited tracked files with `git ls-files` | Future commits now exclude additional debug logs, private key/cert files, and service-account credential filenames |